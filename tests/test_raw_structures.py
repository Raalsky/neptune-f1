...
from f1_2021.packets import *


class TestPacketHeader(object):
...
class TestCarMotionData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestPacketMotionData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestWeatherForecastSample(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestPacketSessionData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestPacketLapData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestTeamMateInPits(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestDriveThroughPenaltyServed(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestStopGoPenaltyServed(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestPacketEventData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestParticipantData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestPacketParticipantsData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestPacketCarSetupData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestCarTelemetryData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestPacketCarTelemetryData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestCarStatusData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestPacketCarStatusData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestFinalClassificationData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestPacketFinalClassificationData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestLobbyInfoData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_ai_controlled', ctypes.c_uint8), # Whether the vehicle is AI (1) or Human (0) controlled
...
class TestPacketLobbyInfoData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestCarDamageData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestPacketCarDamageData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestLapHistoryData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestTyreStintHistoryData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
...
class TestPacketSessionHistoryData(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
            ('m_header', PacketHeader), # Header
...
class TestEventDataDetails(object):
    @pytest.mark.parametrize(
        'type_name, type_class',
        [
