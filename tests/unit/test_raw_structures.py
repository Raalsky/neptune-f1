...
class TestWeatherForecastSample:
    @pytest.mark.parametrize(
        "type_name, type_class",
        [
...
class TestDriveThroughPenaltyServed:
    @pytest.mark.parametrize(
        "type_name, type_class",
        [
...
class TestPacketParticipantsData:
    @pytest.mark.parametrize(
        "type_name, type_class",
        [
            ("m_header", PacketHeader),  # Header
...
class TestPacketCarTelemetryData:
    @pytest.mark.parametrize(
        "type_name, type_class",
        [
            ("m_header", PacketHeader),  # Header
...
class TestFinalClassificationData:
    @pytest.mark.parametrize(
        "type_name, type_class",
        [
...
class TestPacketFinalClassificationData:
    @pytest.mark.parametrize(
        "type_name, type_class",
        [
            ("m_header", PacketHeader),  # Header
...
class TestTyreStintHistoryData:
    @pytest.mark.parametrize(
        "type_name, type_class",
        [
...
class TestPacketSessionHistoryData:
    @pytest.mark.parametrize(
        "type_name, type_class",
        [
            ("m_header", PacketHeader),  # Header
